...
/* harmony import */ var _services_app_route_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/app-route-guard */ "./src/app/services/app-route-guard.ts");
/* harmony import */ var _pages_album_list_album_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/album-list/album-list.component */ "./src/app/pages/album-list/album-list.component.ts");
/* harmony import */ var _pages_artist_list_artist_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/artist-list/artist-list.component */ "./src/app/pages/artist-list/artist-list.component.ts");
...
const routes = [
    ...
    { path: 'artist', component: _pages_artist_list_artist_list_component__WEBPACK_IMPORTED_MODULE_6__["ArtistListComponent"], canActivate: [_services_app_route_guard__WEBPACK_IMPORTED_MODULE_4__["AppRouteGuard"]] },
    { path: 'artist/:artist_name', component: _pages_artist_list_artist_list_component__WEBPACK_IMPORTED_MODULE_6__["ArtistListComponent"], canActivate: [_services_app_route_guard__WEBPACK_IMPORTED_MODULE_4__["AppRouteGuard"]] },
    { path: 'album/:id', component: _pages_album_list_album_list_component__WEBPACK_IMPORTED_MODULE_5__["AlbumListComponent"], canActivate: [_services_app_route_guard__WEBPACK_IMPORTED_MODULE_4__["AppRouteGuard"]] },
...
/* harmony import */ var _pages_album_list_album_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/album-list/album-list.component */ "./src/app/pages/album-list/album-list.component.ts");
/* harmony import */ var _pages_artist_list_artist_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/artist-list/artist-list.component */ "./src/app/pages/artist-list/artist-list.component.ts");
/* harmony import */ var _services_app_route_guard__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/app-route-guard */ "./src/app/services/app-route-guard.ts");
...
/* harmony import */ var _services_spofity_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./services/spofity-service */ "./src/app/services/spofity-service.ts");
...
/* harmony import */ var _common_pipes_sort_by_pipe__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./common/pipes/sort-by.pipe */ "./src/app/common/pipes/sort-by.pipe.ts");
/* harmony import */ var _auth_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./auth-module */ "./src/app/auth-module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _pages_album_list_album_list_component__WEBPACK_IMPORTED_MODULE_5__["AlbumListComponent"],
            _pages_artist_list_artist_list_component__WEBPACK_IMPORTED_MODULE_6__["ArtistListComponent"],
            _common_pipes_sort_by_pipe__WEBPACK_IMPORTED_MODULE_13__["SortByPipe"],
        ],
        imports: [
            ...
            _auth_module__WEBPACK_IMPORTED_MODULE_14__["SpotifyAuthModule"].forRoot(),
        ...
        providers: [_services_spofity_service__WEBPACK_IMPORTED_MODULE_10__["SpotifyService"], _services_app_route_guard__WEBPACK_IMPORTED_MODULE_7__["AppRouteGuard"],
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HTTP_INTERCEPTORS"], useClass: _services_auth_interceptor__WEBPACK_IMPORTED_MODULE_8__["AuthInterceptor"], multi: true }],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SpotifyAuthModule", function() { return SpotifyAuthModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_spotify_auth_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/spotify-auth.component */ "./src/app/spotify-auth.component.ts");
...
let SpotifyAuthModule = SpotifyAuthModule_1 = class SpotifyAuthModule {
    static authRoutes() {
        return routes;
    }
    static forRoot() {
...
SpotifyAuthModule = SpotifyAuthModule_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SpotifyAuthResponse", function() { return SpotifyAuthResponse; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SpotifyAuthRequest", function() { return SpotifyAuthRequest; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_spofity_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/spofity-service */ "./src/app/services/spofity-service.ts");
...
let AlbumListComponent = class AlbumListComponent {
    constructor(spotifyService, route, router) {
...
AlbumListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./album-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/album-list/album-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./album-list.component.css */ "./src/app/pages/album-list/album-list.component.css")).default]
    })
], AlbumListComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_spofity_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/spofity-service */ "./src/app/services/spofity-service.ts");
...
let ArtistListComponent = class ArtistListComponent {
    constructor(_spotifyService, authService, router, route) {
    ...
    searchMusic() {
        ...
        if (this.searchStr != '' && this.searchStr != null) {
            this._spotifyService.searchMusic(this.searchStr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((listing) => listing.artists.items
...
ArtistListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./artist-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/artist-list/artist-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./artist-list.component.css */ "./src/app/pages/artist-list/artist-list.component.css")).default]
    })
], ArtistListComponent);
...
let LoginComponent = class LoginComponent {
    ...
    login() {
        window.location.href = 'https://accounts.spotify.com/en/authorize/' +
            '?response_type=code&client_id=' + _config_json__WEBPACK_IMPORTED_MODULE_4__["clientId"] +
            '&scope=' + encodeURIComponent('user-read-private user-read-email') +
            '&redirect_uri=' + encodeURIComponent(location.origin + '/' + _config_json__WEBPACK_IMPORTED_MODULE_4__["redirectUri"]) + '';
    }
};
...
/* harmony import */ var _spofity_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./spofity-service */ "./src/app/services/spofity-service.ts");
...
let AuthGuard = class AuthGuard {
    constructor(tokenSvc, spotifyServivce, authService) {
        this.tokenSvc = tokenSvc;
...
let AuthInterceptor = class AuthInterceptor {
    intercept(req, next) {
        ...
        if (idToken) {
            ...
            return next.handle(cloned).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])((error) => {
...
/* harmony import */ var _common_spotify_auth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../common/spotify-auth */ "./src/app/common/spotify-auth.ts");
...
let AuthService = class AuthService {
    ...
    getToken(data) {
        ...
        let credentials = 'code=' + data.code + '&grant_type=authorization_code' + '&redirect_uri=' + data.redirect_uri + '&client_id='
            + _config_json__WEBPACK_IMPORTED_MODULE_8__["clientId"] + '&client_secret=' + _config_json__WEBPACK_IMPORTED_MODULE_8__["clientSecret"];
    ...
    setSession(authResult) {
        const expiresAt = moment__WEBPACK_IMPORTED_MODULE_3__().add(authResult.expires_in, 'second');
...
module.exports = __webpack_require__(/*! C:\Spotify-App\src\main.ts */"./src/main.ts");
